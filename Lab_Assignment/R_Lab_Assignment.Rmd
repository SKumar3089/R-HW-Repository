...
# Answer:
sprintf("There are total of %d variables and %d observations in this data set.",num_vars,num_obs)
```
...
# Answer:
sprintf("There are %d discrete variables and %d continuous variables in this data set.",num_discrete,num_continuous)
```
